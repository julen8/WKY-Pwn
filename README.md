...
fork from https://github.com/Mintneko/WKY-Pwn


这个脚本是来自于 <a href=https://github.com/TheOfficialFloW/PPPwn>PPPwn</a> and <a href=https://github.com/xfangfang/PPPwn_cpp>PPPwn_cpp</a> 关于针对 Amlogic S805来运行 <a href=https://github.com/GoldHEN/GoldHEN>GoldHen</a> 在PS4 的 11.0, 9.00版本进行自动化运行<br>
...
```sh
sudo cp /usr/share/zoneinfo/Asia/Shanghai  /etc/localtime #中国大陆  
bash <(curl -sSL https://linuxmirrors.cn/main.sh)  #按需选择即可 如果不理解可以选择1然后按回车
#这两条是为中国大陆用户准备
